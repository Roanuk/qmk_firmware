...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        // right hand
             ...
             TG(MDIA),    KC_J,   KC_L,   KC_U,   KC_Y,   KC_SCLN,          KC_BSLS,
...
[SYMB] = LAYOUT_ergodox(
       // left hand
       RGB_HUI,KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_TRNS,
       RGB_HUD,KC_EXLM,KC_AT,  KC_LCBR,KC_RCBR,KC_PIPE,KC_TRNS,
       RGB_SAI,KC_HASH,KC_DLR, KC_LPRN,KC_RPRN,KC_GRV,
       RGB_SAD,KC_PERC,KC_CIRC,KC_LBRC,KC_RBRC,KC_TILD,KC_TRNS,
       RGB_TOG,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,
                                       LCTL(KC_X),KC_TRNS,
                                               KC_TRNS,
                               LCTL(KC_V),LCTL(KC_C),KC_TRNS,
       // right hand
       KC_TRNS, KC_F6,   KC_F7,  KC_F8,   KC_F9,   KC_F10,  KC_F11,
       KC_TRNS, KC_UP,   KC_7,   KC_8,    KC_9,    KC_ASTR, KC_F12,
                KC_DOWN, KC_4,   KC_5,    KC_6,    KC_PLUS, RGB_VAI,
       KC_TRNS, KC_AMPR, KC_1,   KC_2,    KC_3,    KC_BSLS, RGB_VAD,
                         KC_TRNS,KC_DOT,  KC_0,    KC_EQL,  RGB_MOD,
       KC_TRNS, LCTL(KC_S),
       KC_TRNS,
       KC_TRNS, LCTL(KC_Z), LCTL(KC_Y)
),
